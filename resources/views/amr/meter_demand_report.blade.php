              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header modal-header_form">
                      <h5 class="modal-title">Generate Demand Report</h5>
								...
								<div class="row mb-2">
									...
									<div class="row mb-2">
									  ...
									  <div class="col-sm-9">
										...
										<option value="fifteen">15 Minute</option>
						...
						<div class="col-sm-12 d-flex justify-content-end">
							...
							<div id="save_options"></div>
									...
									<div class="table-responsive">
										<table class="table dataTable display nowrap cell-border"  id="meter_demand_html_table" width="100%" cellspacing="0">
											<thead>
												<tr class="report">
													<th>#</th>
													<th style="">Datetime</th>
													<th style="">Date Start</th>
													<th style="">Start Reading</th>
													<th style="">Date End</th>
													<th style="">End Reading</th>
													<th style="">Multiplier</th>
													<th style="">KW</th>
												</tr>
											</thead>				
