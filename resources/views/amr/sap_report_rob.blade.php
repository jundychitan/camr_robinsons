          ...
          <div class="card">
            ...
            <div class="card-body">			
				<div class="p-d3">
						...
						<div class="col-sm-12">
							<div class="ms-2">
								<div class="fw-bold">BUSINESS ENTITY: <span id="business_entity" style="font-weight: normal;"></span></div>
							</div>
							<div class="ms-2">
								<div class="fw-bold">SITE CODE: <span id="site_code" style="font-weight: normal;"></span></div>			
							</div>
							<div class="ms-2">
								<div class="fw-bold">SITE DESCRIPTION: <span id="site_description" style="font-weight: normal;"></span></div>
							</div>
							<div class="ms-2">
								<div class="fw-bold">BUILDING CODE: <span id="building_code" style="font-weight: normal;"></span></div>
							</div>
							<div class="ms-2">
								<div class="fw-bold">BUILDING NAME: <span id="building_name" style="font-weight: normal;"></span></div>
							</div>
							<div class="ms-2">
								<div class="fw-bold">CUT OFF: <span id="cut_off" style="font-weight: normal;"></span></div>
							</div>
									...
									<div class="table-responsive table-data-span">
										<table class="table table-bordered dataTable" id="sap_report_html_table" width="100%" cellspacing="0">
											<thead>
												...
												<th scope="col">Current Cons.</th>
												<th scope="col">Previous Cons.</th>
